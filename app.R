               ...
               column(2,
                      wellPanel(h3("Input Data to test significance of clusters "),
                                selectInput("Sig_file1",label= "Select an example dataset or upload your own with 'Load my own GW data.'", 
                                            choices = c("Example Data"="Sig_Example", "Load my own data" = "load_my_own_Sig")),
                                ...
                                conditionalPanel("input.Sig_file1 == 'Sig_Example'", downloadButton('download_Sig_Ex', 'Download Example DataSet'))
                      ),
                      ...
                      conditionalPanel("input.cPanels2==3 | input.cPanels2==4",
                                       wellPanel(
                                         ...
                                         conditionalPanel("input.cPanels2==3 & input.Sig_cutcolden == 'TRUE' & input.Sig_pvalue_cal == 'TRUE'" , 
                                                          selectInput("Sig_file3", label= "Select a dataset or upload your own with 'Load my own data.'", choices = c("Meth Sampling Data" ="Sig_Meth.Example", "Load my own sampling data" = "Sig_load_my_own_s_data"))),
                                        ...
                                        #                  numericInput("Sig_n_iter", "No. of iterations for bootstrap:", 1000)),
                                         ...
                                         conditionalPanel("input.cPanels2==4 & input.Sig_cutrowden == 'TRUE' & input.Sig_pvalue_cal2 == 'TRUE' " , 
                                                          selectInput("Sig_file5", label= "Select a dataset or upload your own with 'Load my own data.'", choices = c("Example Meth Sampling Data" ="Sig_Meth.Example2", "Load my own sampling data" = "load_my_own_s_data2"))),
...
server <- function(input, output) {
  ...
  output$download_GW_Ex2 <- downloadHandler(
    ...
    content = function(file) {
      d <- readRDS("data/CoMMpassIA9_GW_Expression_data.rds")
      write.csv(d, file, row.names = FALSE) }
  )
 ...
 output$com_text14 <- renderUI({
  ...
  output$download_Sig_Ex <- downloadHandler(
  ...
  Sig_data_input <- reactive({
    if(input$Sig_file1 == 'Sig_Example'){
      ...
      output$Sig_pvalue <- renderUI({
        ...
        isolate(
          ...
          if(input$Sig_cutcolden == 'TRUE') {
            ...
            {
              if(input$Sig_file3 == 'Sig_Meth.Example'){
      ...
      output$Sig_pvalue2 <- renderUI ({
        ...
        isolate(
          ...
          if(input$Sig_cutrowden== TRUE){
            ...
            {
              if(input$Sig_file5 == 'Sig_Meth.Example2'){
                s_data <- readRDS("data/Meth27K.GW.BRCA.Example.data.rds")
              }
              else {
